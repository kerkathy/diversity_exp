...
def make_hotpotqa_documents(elasticsearch_index: str, metadata: Dict = None):
    # TODO: rm tmp fix
    # tmp fix (only for this directory!!!!)
    raw_glob_filepath = os.path.join("../../ircot", "raw_data", "hotpotqa", "wikpedia-paragraphs", "*", "wiki_*.bz2")
...
def make_iirc_documents(elasticsearch_index: str, metadata: Dict = None):
    ...
    raw_filepath = os.path.join("../../ircot", "raw_data", "iirc", "context_articles.json")
...
def make_2wikimultihopqa_documents(elasticsearch_index: str, metadata: Dict = None):
    # tmp fix (only for this directory!!!!)
    raw_filepaths = [
        os.path.join("../../ircot", "raw_data", "2wikimultihopqa", "train.json"),
        os.path.join("../../ircot", "raw_data", "2wikimultihopqa", "dev.json"),
        os.path.join("../../ircot", "raw_data", "2wikimultihopqa", "test.json"),
    ]
    metadata = metadata or {"idx": 1}
    assert "idx" in metadata
...
def make_musique_documents(elasticsearch_index: str, metadata: Dict = None):
    raw_filepaths = [
        os.path.join("../../ircot", "raw_data", "musique", "musique_ans_v1.0_dev.jsonl"),
        os.path.join("../../ircot", "raw_data", "musique", "musique_ans_v1.0_test.jsonl"),
        os.path.join("../../ircot", "raw_data", "musique", "musique_ans_v1.0_train.jsonl"),
        os.path.join("../../ircot", "raw_data", "musique", "musique_full_v1.0_dev.jsonl"),
        os.path.join("../../ircot", "raw_data", "musique", "musique_full_v1.0_test.jsonl"),
        os.path.join("../../ircot", "raw_data", "musique", "musique_full_v1.0_train.jsonl"),
    ]
    metadata = metadata or {"idx": 1}
    assert "idx" in metadata
