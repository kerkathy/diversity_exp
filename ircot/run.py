...
def main():
    ...
    # modified
    base_parser.add_argument("--similarity_threshold", type=int, help="0~100")
    ...
    config_filepath = get_config_file_path_from_name_or_path(args.experiment_name_or_path, args.similarity_threshold)
